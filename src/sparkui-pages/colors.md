...
# Colors
In sparkUI we have 7 Primary colors, 7 Accent colors, 28 Semantic colors, 19 Neutral colors, 15 Data Visuals / Sequential colors and 7 Data Visuals / Categorical colors.


## Primary
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue-text u-color-neutral--sky-white">
    navy-blue-text <br /> #333944
  </div>
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue-darker u-color-neutral--sky-white">
    navy-blue-darker <br /> #00143d
  </div>
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue-dark u-color-neutral--sky-white">
    navy-blue-dark <br /> #002061
  </div>
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue u-color-neutral--sky-white">
    navy-blue <br /> #00287a
  </div>
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue-light u-color-neutral--sky-white">
    navy-blue-light <br /> #325294
  </div>
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue-lighter">
    navy-blue-lighter <br /> #e5e9f1
  </div>
  <div class="c-spark-docs-colors-item u-bg-primary--navy-blue-lightest">
    navy-blue-lightest <br /> #f4f6f9
  </div>
</div>

## Accent
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-accent--blue-text u-color-neutral--sky-white">
    blue-text <br /> #28435b
  </div>
  <div class="c-spark-docs-colors-item u-bg-accent--blue-darker u-color-neutral--sky-white">
    blue-darker <br /> #005b99
  </div>
  <div class="c-spark-docs-colors-item u-bg-accent--blue-dark u-color-neutral--sky-white">
    blue-dark <br /> #0089e5
  </div>
  ...
  <div class="c-spark-docs-colors-item u-bg-accent--blue-lighter">
    blue-lighter <br /> #e5f4ff
  </div>
  <div class="c-spark-docs-colors-item u-bg-accent--blue-lightest">
    blue-lightest <br /> #f4faff
  </div>
</div>
...
### Green
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-semantic--green-text u-color-neutral--sky-white">
    green-text <br /> #32503c
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--green-darker u-color-neutral--sky-white">
    green-darker <br /> #005f31
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--green-dark u-color-neutral--sky-white">
    green-dark <br /> #00984f
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--green u-color-neutral--sky-white">
    green<br /> #00bf63
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--green-light">
    green-light <br /> #32cb82
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--green-lighter">
    green-lighter <br /> #e5f8ef
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--green-lightest">
    green-lightest <br /> #f4fcf8
  </div>
</div>

### Yellow
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow-text u-color-neutral--sky-white">
    yellow-text <br /> #604f36
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow-darker u-color-neutral--sky-white">
    yellow-darker <br /> #7f5e00
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow-dark u-color-neutral--sky-white">
    yellow-dark <br /> #cc9600
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow u-color-neutral--sky-white">
    yellow<br /> #ffbc00
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow-light">
    yellow-light <br /> #ffc932
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow-lighter">
    yellow-lighter <br /> #fff8e5
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--yellow-lightest">
    yellow-lightest <br /> #fffcf4
  </div>
</div>

### Orange
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-semantic--orange-text u-color-neutral--sky-white">
    orange-text <br /> #624b35
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--orange-darker u-color-neutral--sky-white">
    orange-darker <br /> #7f5200
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--orange-dark u-color-neutral--sky-white">
    orange-dark <br /> #cc8400
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--orange u-color-neutral--sky-white">
    orange<br /> #ffa500
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--orange-light">
    orange-light <br /> #ffa232
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--orange-lighter">
    orange-lighter <br /> #fff6e5
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--orange-lightest">
    orange-lightest <br /> #fffbf4
  </div>
</div>

### Red
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-semantic--red-text u-color-neutral--sky-white">
    red-text <br /> #603a36
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--red-darker u-color-neutral--sky-white">
    red-darker <br /> #792110
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--red-dark u-color-neutral--sky-white">
    red-dark <br /> #c13419
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--red u-color-neutral--sky-white">
    red<br /> #f24220
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--red-light">
    red-light <br /> #f4674c
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--red-lighter">
    red-lighter <br /> #fdece8
  </div>
  <div class="c-spark-docs-colors-item u-bg-semantic--red-lightest">
    red-lightest <br /> #fef7f5
  </div>
</div>
...
### Sky
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-neutral--sky-darker">
    sky-darker <br /> #b7bac0
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--sky-dark">
    sky-dark <br /> #dcdee3
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--sky">
    sky<br /> #e5e9f1
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--sky-light">
    sky-light <br /> #f2f4f8
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--sky-lighter">
    sky-lighter <br /> #f9fafc
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--sky-lightest">
    sky-lightest <br /> #fcfcfd
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--sky-white">
    sky-white <br /> #ffffff
  </div>
</div>
...
### Ink
<div class="c-spark-docs-colors-container">
  <div class="c-spark-docs-colors-item u-bg-neutral--ink u-color-neutral--sky-white">
    ink<br /> #16253f
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--ink-light u-color-neutral--sky-white">
    ink-light <br /> #445065
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--ink-lighter u-color-neutral--sky-white">
    ink-lighter <br /> #737c8b
  </div>
  <div class="c-spark-docs-colors-item u-bg-neutral--ink-lightest u-color-neutral--sky-white">
    ink-lightest <br /> #a1a7b2
  </div>
</div>
